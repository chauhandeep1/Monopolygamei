...
rollDice = (ply) => {
  ...
  if (dice1 === 1) {
    d1Disp.style.backgroundImage = "url('dice1.png')";
  } else if (dice1 === 2) {
    d1Disp.style.backgroundImage = "url('dice2.png')";
  } else if (dice1 === 3) {
    d1Disp.style.backgroundImage = "url('dice3.png')";
  } else if (dice1 === 4) {
    d1Disp.style.backgroundImage = "url('dice4.png')";
  } else if (dice1 === 5) {
    d1Disp.style.backgroundImage = "url('dice5.png')";
  } else if (dice1 === 6) {
    d1Disp.style.backgroundImage = "url('dice6.png')";
  }
  if (dice2 === 1) {
    d2Disp.style.backgroundImage = "url('dice1.png')";
  } else if (dice2 === 2) {
    d2Disp.style.backgroundImage = "url('dice2.png')";
  } else if (dice2 === 3) {
    d2Disp.style.backgroundImage = "url('dice3.png')";
  } else if (dice2 === 4) {
    d2Disp.style.backgroundImage = "url('dice4.png')";
  } else if (dice2 === 5) {
    d2Disp.style.backgroundImage = "url('dice5.png')";
  } else if (dice2 === 6) {
    d2Disp.style.backgroundImage = "url('dice6.png')";
  }
  if (dice1 === dice2) {
    rollDoubles = true;
  }
